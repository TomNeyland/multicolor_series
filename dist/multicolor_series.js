...
Highcharts.seriesTypes.coloredline.prototype.processData = function(force) {
...
Highcharts.seriesTypes.coloredline.prototype.setTooltipPoints = function(renew) {
    var series = this,
        points = [],
        pointsLength,
        low,
...
Highcharts.seriesTypes.coloredline.prototype.drawTracker = function() {
    var series = this,
        options = series.options,
...
Highcharts.seriesTypes.coloredline.prototype.setState = function(state) {
    var series = this,
        options = series.options,
        graph = series.graph,
 ...
 *
 ***/
Highcharts.seriesTypes.coloredline.prototype.getSegments = function(f) {
    var series = this,
        lastColor = 0,
        segments = [],
        i,
...
Highcharts.seriesTypes.coloredline.prototype.getGraphPath = function(f) {
...
Highcharts.seriesTypes.coloredline.prototype.drawGraph = function(f) {
    var series = this,
        options = series.options,
        props = [
            ['graph', options.lineColor || series.color]
        ],
        lineWidth = options.lineWidth,
...
Highcharts.seriesTypes.coloredarea.prototype.init = function(chart, options) {
    options.threshold = options.threshold || null;
    Highcharts.Series.prototype.init.call(this, chart, options);
};

Highcharts.seriesTypes.coloredarea.prototype.closeSegment = Highcharts.seriesTypes.area.prototype.closeSegment;

Highcharts.seriesTypes.coloredarea.prototype.drawGraph = function(f) {
    Highcharts.seriesTypes.coloredline.prototype.drawGraph.call(this, f);
    var series = this,
...
Highcharts.seriesTypes.coloredarea.prototype.getSegmentPath = function(segment) {
    var path;
